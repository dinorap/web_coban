  ...
  document.write(`
        <div class="category-header-container">
            <div class="header-category">
                <ul class="list-category">
                    ...
                    <li class="category-item"><a href="#">Pháp luật</a></li>
                    <li class="category-item"><a href="#">Đời sống</a></li>
                    <li class="category-item"><a href="#">Khoa học - Công nghệ</a></li>
                    <li class="category-item"><a href="#">Thể Thao</a></li>
                    <li class="category-item"><a href="#">Giáo Dục</a></li>                  
        ...
        <div class="all-category-left-section">
            <ul class="group-category-sub-category">
                <li class="category-title"><a href="#" class="text-uppercase">Văn hoá - Giải trí</a></li>
                <li class="sub-category"><a href="#">Sao Việt</a></li>
            ...
            <ul class="group-category-sub-category">
                <li class="category-title"><a href="#" class="text-uppercase">Sức khoẻ</a></li>
                <li class="sub-category"><a href="#">Covid - 19</a></li>
                <li><a href="#">Tin Tức</a></li>
                <li><a href="#">Dinh dưỡng</a></li>
                <li><a href="#">Bệnh và thuốc</a></li>
                <li><a href="#">Giới tính</a></li>
                <li><a href="#">Khác</a></li>
            </ul>
            <ul class="group-category-sub-category">
                <li class="category-title"><a href="#" class="text-uppercase">Thể Thao</a></li>
                <li class="sub-category"><a href="#">Thể thao Việt Nam</a></li>
                <li><a href="#">Bóng đá</a></li>
                <li><a href="#">Esport</a></li>
                <li><a href="#">Lịch thi đấu </a></li>
                <li><a href="#">Tennis</a></li>
                <li><a href="#">Thể thao thế giới</a></li>
            </ul>
            <ul class="group-category-sub-category">
                <li class="category-title"><a href="#" class="text-uppercase">Đời sống</a></li>
                <li class="sub-category"><a href="#">Giới trẻ</a></li>
                <li><a href="#">Chuyện bốn phương</a></li>
                <li><a href="#">Gia đình</a></li>
                <li><a href="#">Ý kiến</a></li>
                
            </ul>
            <ul class="group-category-sub-category">
                <li class="category-title"><a href="#" class="text-uppercase">Giáo dục</a></li>
                <li class="sub-category"><a href="#">Tin tức</a></li>
            ...
            <ul class="group-category-sub-category">
                <li class="category-title"><a href="#" class="text-uppercase">Kinh tế</a></li>
                <li class="sub-category"><a href="#">Đầu tư</a></li>
            ...
            <ul class="group-category-sub-category">
                <li class="category-title"><a href="#" class="text-uppercase">Khoa học - Công nghệ</a></li>
                <li class="sub-category"><a href="#">Sản phẩm</a></li>
            ...
            <ul class="group-category-sub-category">
                <li class="category-title"><a href="#" class="text-uppercase">Pháp Luật</a></li>
                <li class="sub-category"><a href="#">Luật pháp Việt Nam</a></li>
                <li><a href="#">Hòm thư pháp luật</a></li>
                <li><a href="#">Bản tin 113</a></li>
